  ...
  return (
    <div className="crypto-detail-page">
      ...
      <section className="cta-box-section">
        <div className="container-xl">
          <h2 className="h2-style" style={{color: '#000'}}>Architect a Sustainable Economy for Your Vision</h2>
          <p className="p-style" style={{color: '#555', marginTop: '15px', maxWidth: '800px', margin: '15px auto 0'}}>
            A beautiful concept needs a strong engine. Let our financial engineers design the math behind your success.
          </p>
          <a href="#h-hero" className="form-button" style={{display: 'inline-block', width: 'auto', padding: '18px 48px', marginTop: '30px', textDecoration: 'none'}}>Request Tokenomics Plan</a>
        </div>
      </section>
