...
const ExchangeCommunicationSubDetailView: React.FC = () => {
  ...
  return (
    <div className="crypto-detail-page">
      ...
      <section id="h-hero">
        <img src="https://images.unsplash.com/photo-1521791136064-7986c2959210?q=80&w=2832" className="bg-img" alt="Exchange Communication Hero" />
...
export default ExchangeCommunicationSubDetailView;