...
const Web3WebsiteDevSubDetailView: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setLoading(true);
    const result = await evaluateProject(status, `Web3 Website: ${goal}`);
    setAiResult(result);
    setLoading(false);
  };
  ...
  return (
    <div className="crypto-detail-page">
      ...
      <section id="h-hero">
        <img src="https://images.unsplash.com/photo-1558655146-d09347e92766?q=80&w=2832" className="bg-img" alt="Web Development" />
...
export default Web3WebsiteDevSubDetailView;