...
const Hero: React.FC = () => {
  return (
    <section className="relative pt-32 pb-20 overflow-hidden bg-black text-white min-h-screen flex flex-col items-center">
      {/* Önizleme için canlı URL eklendi (Orijinal dosya adı: c1.jpg) */}
      <img src="https://images.unsplash.com/photo-1639322537228-f710d846310a?auto=format&fit=crop&q=80&w=2000" alt="Process Background" className="absolute top-0 left-0 w-full h-full object-cover z-0" />
