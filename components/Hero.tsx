    ...
    <section className="relative pt-32 pb-20 overflow-hidden bg-black text-white min-h-screen flex flex-col items-center">
      ...
      <div className="relative z-10 w-full max-w-[1280px] px-8 pt-12">
        <div className="text-center mb-8 px-4 md:px-24">
          <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-6 drop-shadow-[0_10px_20px_rgba(0,0,0,1)]">
          ...
          <h3 className="text-cray-gold text-xl md:text-2xl font-semibold drop-shadow-[0_2px_10px_rgba(255,177,0,0.3)]">
        ...
        <div className="relative h-[20rem] my-12 mx-auto max-w-[75rem] hidden lg:block">
          ...
          {steps.map((step, idx) => (
            ...
            >
              ...
              <div className="w-12 h-12 rounded-full border-2 border-cray-gold bg-white flex items-center justify-center font-bold text-black cursor-pointer transition-all duration-300 hover:scale-110 hover:shadow-[0_0_30px_rgba(255,177,0,0.6)]">
                {step.number}
              </div>
            </div>
          ))}
        ...
        <div className="text-center mt-12">
          <a href="#section1" className="bg-cray-gold text-black px-12 py-4 rounded-lg font-bold text-lg inline-block transition-all duration-300 hover:scale-105 shadow-[0_4px_30px_rgba(255,177,0,0.5)]">
