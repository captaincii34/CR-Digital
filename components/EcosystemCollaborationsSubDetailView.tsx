...
const EcosystemCollaborationsSubDetailView: React.FC = () => {
  ...
  return (
    <div className="crypto-detail-page">
      ...
      <section id="h-hero">
        <img src="https://images.unsplash.com/photo-1639322537228-f710d846310a?q=80&w=2832" className="bg-img" alt="Ecosystem Hero" />
...
export default EcosystemCollaborationsSubDetailView;