...
const ListingDocumentationSubDetailView: React.FC = () => {
  ...
  return (
    <div className="crypto-detail-page">
      ...
      <section id="h-hero">
        <img src="https://images.unsplash.com/photo-1450101499163-c8848c66ca85?q=80&w=2832" className="bg-img" alt="Documentation Hero" />
...
export default ListingDocumentationSubDetailView;