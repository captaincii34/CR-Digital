...
const PrMediaPublicationsSubDetailView: React.FC = () => {
  ...
  const reasons = [
    { title: 'Tier-1 Coverage', desc: 'We secure placements in global giants like Cointelegraph, Coindesk, Forbes, and Bloomberg.', icon: <path d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10l4 4v10a2 2 0 01-2 2z"/><path d="M7 8h5M7 12h8M7 16h8"/> },
    { title: 'Global Authority', desc: 'Strategic PR establishes your project as a credible, legitimate player in the eyes of VCs and exchanges.', icon: <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/> },
  ...
  return (
    <div className="crypto-detail-page">
      ...
      <section id="h-hero">
        <img src="https://images.unsplash.com/photo-1557804506-669a67965ba0?q=80&w=2832" className="bg-img" alt="PR Hero" />
        <div className="overlay"></div><div className="grad"></div>
        <div className="container-xl">
          <div className="hero-grid">
            <div className="hero-text">
              <h5 style={{color: 'var(--cray-gold)', letterSpacing: '4px', textTransform: 'uppercase', marginBottom: '20px'}}>Global Media Authority</h5>
              <h1 className="h1-style">PR & Media Publications</h1>
              <p className="p-style">Tell your story to the world. We secure top-tier media coverage that builds unmatched credibility and drives global interest in your Web3 project.</p>
            </div>
