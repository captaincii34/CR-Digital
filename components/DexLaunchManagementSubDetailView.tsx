...
const DexLaunchManagementSubDetailView: React.FC = () => {
  ...
  return (
    <div className="crypto-detail-page">
      ...
      <section id="h-hero">
        <img src="https://images.unsplash.com/photo-1639762681485-074b7f938ba0?q=80&w=2832" className="bg-img" alt="DEX Hero" />
...
export default DexLaunchManagementSubDetailView;