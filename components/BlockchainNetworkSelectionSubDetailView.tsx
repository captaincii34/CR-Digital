  ...
  const reasons = [
    {
      ...
      desc: 'Don’t let transaction fees (gas fees) end your project’s user experience. We choose the most economical network for your transaction volume.'
    },
    {
      icon: <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/>,
      title: "Speed & Scalability",
      desc: 'We build infrastructures that support thousands of transactions per second (TPS), ready for the traffic of the future, and do not experience congestion.'
    },
    {
      icon: <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>,
      title: 'Ecosystem Alignment',
      desc: 'According to your project’s liquidity goals; we choose the right one among Ethereum, Solana, BNB or Layer-2 networks.'
    }
  ];

  const faqs = [
    { q: "Which blockchain should I choose?", a: "This depends entirely on the type of your project. DeFi projects may prefer Ethereum/Layer2 networks for liquidity, while GameFi projects may prefer Solana or Polygon for speed." },
    { q: "Are Layer 2 solutions safe?", a: "Networks like Arbitrum, Optimism, and Base inherit the security of the Ethereum mainnet while offering very low costs. We integrate them into your project in the most efficient way." },
    { q: "Do you build cross-chain bridges?", a: "Yes, we design secure multichain and bridge architectures so that your project can run on multiple networks." }
  ];
  ...
  return (
    <div className="crypto-detail-page">
      ...
      <section id="h-hero">
        ...
        <div className="container-xl">
          <div className="hero-grid">
            <div style={{flex: 1.2}}>
              <h5 style={{color: 'var(--cray-gold)', letterSpacing: '4px', textTransform: 'uppercase', marginBottom: '20px'}}>Infrastructure Decision Support</h5>
              <h1 className="h1-style">Blockchain & Network Selection</h1>
          ...
          <div className="detail-row">
            <div className="detail-item">
              <div className="detail-visual">
                <img src="https://images.unsplash.com/photo-1639322537228-f710d846310a?q=80&w=2000" alt="Performance" />
              </div>
              <div className="detail-text">
                <h2 className="h2-style">Performance vs. Cost Analysis</h2>
                <p className="p-style">Every transaction counts. We perform a deep analysis of gas price histories and block times across Layer 1 and Layer 2 solutions to find the perfect balance between user affordability and decentralized security.</p>
                <ul style={{listStyle: 'none', padding: 0, marginTop: '24px'}}>
                  {["Gas-Fee Backtesting", "Throughput Stress Modeling", "EVM vs Non-EVM Benchmarking"].map((li, i) => (
      ...
      <section className="cta-box-section">
        <div className="container-xl">
          <h2 className="h2-style" style={{color: '#000'}}>Architect Your Multi-Chain Future Today</h2>
